...
for count,val in enumerate(vary_arr):
    ...
    plt.savefig('/home/cemoser/Repositories/emu_CAMELS/figures/derivatives/'+suite+'_'+vary_str+'_'+prof+'_deriv3d_w.png')
    plt.close()
    ...
    plt.savefig('/home/cemoser/Repositories/emu_CAMELS/figures/derivatives/'+suite+'_'+vary_str+'_'+prof+'_deriv2d_w.png')
    plt.close()
