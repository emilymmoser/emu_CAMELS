...
derivatives_rho=np.genfromtxt('/home/cemoser/Repositories/emu_CAMELS/derivative_arrays/'+suite+'_rho_mean_uw_'+mass_str+'.txt')    
derivatives_pth=np.genfromtxt('/home/cemoser/Repositories/emu_CAMELS/derivative_arrays/'+suite+'_pth_mean_uw_'+mass_str+'.txt')
